package com.sparta.grimebe.global.exception;
...
import com.sparta.grimebe.global.exception.dto.ValidationDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseResponseDTO> runtimeExceptionHandler(RuntimeException e){
        ...
        BaseResponseDTO errorResponse = new BaseResponseDTO("알수 없는 오류가 발생하였습니다.",400);
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(errorResponse);
    }
}
