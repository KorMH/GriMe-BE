...
public class PostLikeController {
    ...
    @PostMapping("/likes")
    public ResponseEntity<BaseResponseDTO> likePost(@PathVariable Long postId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
        BaseResponseDTO response = postLikeService.likePost(postId, userDetails);
